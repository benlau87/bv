 ...
 * @link     https://www.magetrend.com/magento-2-pdf-invoice-pro
 */
class OrderUpdate extends \Magetrend\PdfTemplates\Observer\Framework\Mail\AttachmentAbstract
{
    public function execute(Observer $observer)
    {
        ...
        $this->attachFile($observer, $pdf, __('order_%1.pdf', $order->getIncrementId()));
    }
}
